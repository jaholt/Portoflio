...
# Generation Time: 2018-10-01 12:46:54 +0000
# ************************************************************
...
INSERT INTO `aboutMe` (`id`, `title`, `fillText`)
VALUES
	(1,'About Me','Once completed I will have the fundamentals of coding, software design and agile project management. Complimented by my previous experience in other industries I will have the ability to apply these skills in real world programming situations.'),
	(2,'Technologies','I will be able to successfully handle and apply the following technologies:'),
	(3,'Previous Experience','I have experience working in other industries. I spent some time working for a Executive Recruitment firm based in Westminster that mainly operated in the charity and education sectors.'),
	(4,'Other Experience','I attained a BA in History from Royal Holloway, University of London. I also have experience working in the Army Reserves where I qualified as a trooper in the Honourable Artillery Company.');
